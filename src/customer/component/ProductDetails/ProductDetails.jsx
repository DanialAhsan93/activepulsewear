...
import { gym_fit } from '../../../Data/gum_fit';
      ...
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className='flex flex-wrap space-x-5 justify-center'>
              {product.images.map((item) => (
                <div className=" lg:grid lg:grid-cols-1 lg:gap-y-8 max-w-[5rem] max-h-[5rem] pt-4">
                  <img
                    alt={item.alt}
                    src={item.src}
          ...
          <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24 ">
            <div className="lg:col-span-2">
              <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Active pulse wear</h1>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                <Button onClick={handleAddToCart} variant="contained" sx={{ px: "2rem", py: "1rem", bgcolor: "#9155fd", marginTop: "5px" }} >
                  Add To Cart
                </Button>
        ...
        <section>
          ...
          <div className='flex flex-wrap'>
            {gym_fit.map((item)=><Homesectioncard product={item} width={'w-[13rem]'} margin={'my-4'}/>)}
          </div>
        </section>
